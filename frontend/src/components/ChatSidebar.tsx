...
const ChatSidebar = ({
  ...
  return (
    <aside
      className={`fixed z-20 sm:static top-0 left-0 h-screen w-80 bg-gray-900 border-r border-green-700 transform
      ...
      <div className="p-6 border-b border-green-700">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <h2 className="">{showAllUsers ? "New Chat" : "Messages"}</h2>
          </div>
        ...
        {showAllUsers ? (
          <div className="space-y-4 h-full">
            <div className="relative">
              <Search className="absolute left-3 top-1/3 transform -translate-y-1/2 w-4 h-4 text-gray-400 " />
              <input
                type="text"
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      {latestMessage && (
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-sm flex-1 truncate text-gray-400 ">
                            {latestMessage.text}
                          </span>
                        </div>
                      )}
          ...
          <div className="flex flex-col items-center justify-center text-center h-full mb-4">
      ...
      <div className="p-4 border-t border-gray-700 space-y-2">
        ...
        >
          <div className="p-1.5 bg-gray-700 rounded-full">
            <UserCircle className="text-gray-300 h-4 w-4" />
          </div>
        ...
        <button
          ...
          className="w-full flex items-center gap-3 px-4 p-3  rounded-lg hover:bg-red-600 transition-colors text-red-500 hover:text-white"
        >
